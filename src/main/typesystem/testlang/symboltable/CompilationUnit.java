...
public class CompilationUnit extends neverlang.core.typesystem.CompilationUnit<String> {
    public CompilationUnit(Scope<String> scope, InferencingStrategy inferencingStrategy, neverlang.core.typesystem.CompilationUnit<String> compilationUnitParent, Location location, String id) {
